        ...
        <div className="flex flex-col h-full w-full bg-[#0b141b] md:bg-[#fcfdfe] relative overflow-hidden">
            ...
            <div className="flex-1 bg-white rounded-t-[40px] md:rounded-none flex flex-col overflow-hidden">
                ...
                <div
                    ...
                    className="flex-1 overflow-y-auto px-6 md:px-20 pt-10 pb-4 md:pb-10 no-scrollbar relative"
                >
                ...
                {/* ─── INPUT AREA ─── */}
                <div className="sticky bottom-1 md:bottom-0 left-0 w-full px-4 md:px-20 py-4 bg-white/80 backdrop-blur-md z-30">
